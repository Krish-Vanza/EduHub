...
const MyEnrollments = () => {
    ...
    return (
        // 1. Replace <> with a div and add flex classes
        <div className="flex flex-col min-h-screen">

            {/* 2. Add 'flex-grow' to your main content div */}
            <div className='md:px-36 px-8 pt-10 flex-grow'>

                <h1 className='text-2xl font-semibold'>My Enrollments</h1>

                <table className="md:table-auto table-fixed w-full overflow-hidden border mt-10">
                    {/* ... (rest of your table code is unchanged) ... */}
            ...
            {/* This will now be pushed to the bottom of the page */}
            <Footer />

        </div> // 3. Close the new wrapper div instead of </>
    )
}
